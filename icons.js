/* ============================================================
   Nexus OS — inline SVG line icons (24px grid, 1.6 stroke).
   Shared by the landing page, auth page and the portal.
     NXI.svg("flame", 16)  -> "<svg …>…</svg>"
     NXI.has("flame")      -> true
   ============================================================ */
(function () {
  var P = {
    ...
    sparkles: '<path d="M12 2l2.4 7.6L22 12l-7.6 2.4L12 22l-2.4-7.6L2 12l7.6-2.4z"/>',
    ...
    history: '<circle cx="12" cy="12" r="3"/><line x1="3" x2="9" y1="12" y2="12"/><line x1="15" x2="21" y1="12" y2="12"/>',
  ...
  function svg(name, size, cls) {
    ...
    return '<svg class="ico' + (cls ? " " + cls : "") + '" width="' + s + '" height="' + s +
      '" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' + p + "</svg>";
  }
  /* <span data-ico="menu" data-size="18"></span>  ->  filled with the icon */
  function hydrate(root) {
    var list = (root || document).querySelectorAll("[data-ico]");
    for (var i = 0; i < list.length; i++) {
      var n = list[i];
      if (n.getAttribute("data-hydrated")) continue;
      n.insertAdjacentHTML("afterbegin", svg(n.getAttribute("data-ico"), +n.getAttribute("data-size") || 16));
      n.setAttribute("data-hydrated", "1");
    }
  }
  window.NXI = { svg: svg, hydrate: hydrate, has: function (n) { return Object.prototype.hasOwnProperty.call(P, n); }, names: Object.keys(P) };
})();
